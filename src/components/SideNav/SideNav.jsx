    ...
    <>
      {auth && (
        <div className="sidenav-main">
          ...
          <div className="sidenav-hero">
            <div className="sidenav-hero-content">
              ...
              <div className="browse-podcasts">
                ...
                <p>We'll keep you updateed on new episodes</p>
                <button id="browsePodcasts">Browse Podcasts</button>
              </div>
            </div>
          </div>
          <div className="sidenav-footer">
            <FooterOptions fontSize={"0.8rem"} />
      ...
      {!auth && (
        <div className="sidenav-main">
          ...
          <div className="sidenav-hero"></div>
        </div>
      )}
    </>
  );
